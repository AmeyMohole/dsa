/* Consider a scenario for hospital to cater services to different kinds of patients as a)serious b) non-serious c) General Checkup. Implement the priority queue to cater services to the patients.*/
...
Enter Your Choice:-
1
Enter the number of patinents--
2
Enter your name of the patient-- ABC
Enter your Prioritys (0: serious, 1: non-serious, 2: genral checkup)-- 0
Enter your name of the patient-- XYZ
...
Enter Your Choice:-
2
Patient's Name - ABC Priority - 'Serious' 
Patient's Name - XYZ Priority - 'Non-serious' 
1. for Insert the Data in Queue
2. for show the Data in Queue 
3. for Delete the data from the Queue
0 for Exit
